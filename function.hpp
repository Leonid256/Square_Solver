...
enum enum_decisions //корни ур-я
{
    ...
    TWO_ROOTS,  /**< 2 корня */
    // TODO: Infinite (?)
    INFINITE    /**< бесконечное количество корней */
};
//---------------------------------------------------------------------------------------------
/**
...
enum enum_opportunity_user //возврат ф-ии с выбором пользователя
{
    ...
    GO,         /**< продолжение решения уравнений */
    STAT,       /**< открытие статистики */
    CONTINUE,   /**< неверный ввод(новый запрос пользователя)*/
    TEST        /**< открытие раздела тестов */
};
//---------------------------------------------------------------------------------------------
/**
